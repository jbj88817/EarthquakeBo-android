...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONArray featuresJsonArr = root.optJSONArray("features");
            for (int i = 0; i < featuresJsonArr.length(); i++) {
                JSONObject everyFeaturesJsonObj = featuresJsonArr.optJSONObject(i);
                JSONObject propertiesJsonObj = everyFeaturesJsonObj.getJSONObject("properties");
                Earthquake earthquake = new Earthquake();
                double mag = propertiesJsonObj.optDouble("mag");
                String location = propertiesJsonObj.optString("place");
                long time = propertiesJsonObj.optLong("time");
